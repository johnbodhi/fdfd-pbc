...
module global
	...
	real Sx, Sy, Sz, dx, dy, dz,frequency, w, rp, tp, dt;
    real Px, Py, theta_inc, phi_inc, phase_angle, delt, eigen_mod;
    real courant_factor, phase, periodic_kx, periodic_ky;
	...
	integer Nx, Ny, Nz, Nxy, Nxyz, Nu, Npml;
    integer Nxp1, Nyp1, Nzp1
	integer Nxm1, Nym1, Nzm1
	integer Nxm2, Nym2, Nzm2
	real :: pi,c,eps_o,mu_o,nu_o,ko,phi,kx,ky,kz,kh;
